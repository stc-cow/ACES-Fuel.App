...
const initialRows: SiteRow[] = [
  { id: 1, name: "4425", generator: "COWM03", currentLiters: 0, dailyVirtual: 0, lastAvg: 0, rateOk: true, driver: "-", project: "stc-cow", city: "Dammam", address: "Dammam city", active: true },
  { id: 2, name: "3426", generator: "COW6048", currentLiters: 0, dailyVirtual: 0, lastAvg: 0, rateOk: true, driver: "-", project: "stc-cow", city: "Riyadh", address: "RIYADH", active: true },
  { id: 3, name: "cn4n10 1 5.0069E02", generator: "cn4n10", currentLiters: 100, dailyVirtual: 400, lastAvg: 0, rateOk: false, driver: "Khalid Nizar", project: "stc-cow", city: "Dammam", address: "dammam", active: true },
  { id: 4, name: "3425", generator: "t6866", currentLiters: 95, dailyVirtual: 90, lastAvg: 0, rateOk: false, driver: "SHOBAB JAMIL MUHAMMAD JAMAL", project: "Mobily EM", city: "Riyadh", address: "-", active: true },
  { id: 5, name: "3426-3", generator: "COW6148", currentLiters: 0, dailyVirtual: 20, lastAvg: 0, rateOk: false, driver: "-", project: "stc-cow", city: "Jubail", address: "Jubail", active: true },
];
...
export default function SitesPage() {
  ...
  const exportCsv = () => {
    const visible = allColumns.filter((c) => cols[c.key] && !["index","settings"].includes(c.key as string));
      ...
      <div className="px-4 pb-10 pt-4">
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" className="hidden sm:inline-flex" onClick={lessUse}>Less Use</Button>
            <Button variant="outline" className="hidden sm:inline-flex" onClick={mostUse}>Most Use</Button>
